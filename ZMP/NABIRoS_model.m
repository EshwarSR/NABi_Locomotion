...
tibia(mode,r,R,Rtheta1,Rtheta2,-1,[0;-0.05;-0.0558]);
foot(mode,r,R,([0;-0.05;-0.0558]+Rtheta1*([0; -0.39152; 0] + Rtheta2*[0; -0.39857; 0])));

joint(mode,r,R,[0;0.05;-0.0558]);
femur(mode,r,R,Rtheta3,1,[0;0.05;-0.0558]);
joint(mode,r,R,([0;0.05;-0.0558]+Rtheta3*[0; 0.39152; 0]));
tibia(mode,r,R,Rtheta3,Rtheta4,1,[0;0.05;-0.0558]);
foot(mode,r,R,([0;0.05;-0.0558]+Rtheta3*([0; 0.39152; 0] + Rtheta4*[0; 0.39857; 0])));
